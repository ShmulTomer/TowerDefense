...
public class Player {
    ...
    public int getTowerAvailable(int i) {
        return towerAvailable[i];
    }
    public void incrementTowerAvailable(int i) {
        towerAvailable[i]++;
    }
    public int getTotalTowerAvailable() {
        return towerAvailable[0] + towerAvailable[1] + towerAvailable[2];
    }
